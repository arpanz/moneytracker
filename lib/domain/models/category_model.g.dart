...
extension CategoryModelQueryWhereSort
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhere> anyType() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryWhere
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> typeGreaterThan(
    int type, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> typeLessThan(
    int type, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> typeBetween(
    int lowerType,
    int upperType, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByIsCustom() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByIsCustom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCustom', Sort.asc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByIsCustom() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, bool, QQueryOperations> isCustomProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, int, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
